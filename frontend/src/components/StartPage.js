...
/*     document.addEventListener("DOMContentLoaded", function(){
    ...
    /*    <div className={styles.wrapper}>
            {toggle && (
            <button className={ styles.buttonbird} onClick={clickHandler}>
                <p className={styles.buttonbirdText}>SEND</p>
                ...
                viewBox="0 0 75 38" style={"enable-background:new 0 0 75 38"} xmlSpace="preserve">
                    <g>
